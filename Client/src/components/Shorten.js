    ...
    return (
      <div style={{ backgroundColor: "aqua", height: "100vh" }}>
        <div style={{ backgroundColor: "aqua", height: "100%" }}>
          ...
          <div style={{  backgroundColor: "aqua",marginTop: "100px", margin: "40px" }}>
          <div className="urlheader" >
            ...
            <div
              className="heading"
              style={{ margin: "5px", marginTop: "10px",backgroundColor: "aqua"}}>
              Shortening URL
            </div>
              ...
              <div
                ...
                <div
                  ...
                  <input
                    ...
                    name="urll"
                    placeholder="Enter here the url to be shortened..."
                    style={{
                      height: "48px",
                      marginBottom: "5px",
                    }}
          ...
          <div className="outerdiv" >
            <div class="table-responsive">
              <table className="table" style={{ backgroundColor: "aqua", padding: "20px" }}>
                <tbody>
